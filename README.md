...
|---|---|---|
| 🖥️ Web interface and frontend experience | [webapp1](webapp1) | [webapp/README.md](webapp1/README.md) |
...
| 🤖 Only testing backend and frontend with prepared model | [SEGP Trained Models (Kaggle)](https://www.kaggle.com/datasets/chamtgm/segp-trained-models) | CFSIMCLR_finetuned_best.pt -> Proposed model <br />simCLR_finetuned_best.pt -> Baseline Model <br/>best.pt ->YOLO model <br />fruit_centroids(cfsimclr).pt -> CF-SimCLR Centroids for Embeddings Labelling <br />fruit_centroids(simclr).pt -> SimCLR Centroids for Embeddings Labelling
